---
project: immunos-mcp
source: llm_agents_demo.py
type: code-mirror
language: py
size: 18101
modified: 2025-11-30T09:34:49.560576
hash: d20773282d52d928173c386614900d76
description: "All Agents Demo with LLM Enhancement  Demonstrates IMMUNOS-MCP with local Ollama models: 1. Tests Ollama connectivity 2. Runs all 6 immune agents (B Cell, NK Cell, T Cell, Dendritic, Macrophage, QML) "
tags: [code, source, auto-generated]
---

> [!info] Source File
> **Path**: `llm_agents_demo.py`
> **Size**: 18101 bytes
> **Modified**: 2025-11-30
