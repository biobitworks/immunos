---
project: immunos-mcp
source: vulnerable_patterns.py
type: code-mirror
language: py
size: 11801
modified: 2025-11-25T14:24:27.153844
hash: 9e697e2e77fc4c30db52e6898fd1fe1a
description: "Vulnerable Code Patterns Dataset  Curated examples of insecure Python code with known vulnerabilities. These patterns represent "non-self" threats that the system should detect. Each example includes "
tags: [code, source, auto-generated]
---

> [!info] Source File
> **Path**: `vulnerable_patterns.py`
> **Size**: 11801 bytes
> **Modified**: 2025-11-25
