# Claim1_VATPase_Subunits: V-ATPase subunits are dysregulated in tau+ neurons
...
|---------|---------|---------|-----|-------------|
| ATP6V1A | 0.040 | 2.0210e-01 | 4.0419e-01 | ✗ |
...
The claim "V-ATPase subunits are dysregulated in tau+ neurons" is **not supported** by the current data.
