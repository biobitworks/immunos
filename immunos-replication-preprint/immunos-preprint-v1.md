...
ai_contributors:
  ...
  - name: ChatGPT Codex 5.2
    role: Code generation, research assistance
software:
  - name: Claude Code
    provider: Anthropic
...
**AI Contributors**: Cursor Auto Agent, Claude Opus 4.5, ChatGPT Codex 5.2
**Software**: Claude Code, VS Code, Obsidian, Continue
**Date**: December 2025
**Version**: 1.1
